    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <ul class="nav nav-tabs nav-justified mb-3">
                ...
                <li class="nav-item"><a href='{{ route("users.favorites",["id" => $user->id]) }}' class='nav-link {{ Request::is("users/*/favorites") ? "active" : "" }}'>Favorites<span class="badge badge-warning">{{ $count_favorite }}</span></a></li>
            </ul>
